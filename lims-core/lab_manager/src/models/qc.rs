...
pub struct QcMetricDefinition {
    ...
    pub min_value: Option<sqlx::types::BigDecimal>,
    pub max_value: Option<sqlx::types::BigDecimal>,
    pub warning_threshold_low: Option<sqlx::types::BigDecimal>,
    pub warning_threshold_high: Option<sqlx::types::BigDecimal>,
    pub fail_threshold_low: Option<sqlx::types::BigDecimal>,
    pub fail_threshold_high: Option<sqlx::types::BigDecimal>,
...
pub struct LibraryPrepQc {
    ...
    pub concentration_ngul: Option<sqlx::types::BigDecimal>,
    pub volume_ul: Option<sqlx::types::BigDecimal>,
    pub total_yield_ng: Option<sqlx::types::BigDecimal>,
    pub fragment_size_bp: Option<i32>,
    pub fragment_size_cv: Option<sqlx::types::BigDecimal>,
    pub bioanalyzer_rin: Option<sqlx::types::BigDecimal>,
    pub bioanalyzer_trace_path: Option<String>,
    pub qubit_concentration: Option<sqlx::types::BigDecimal>,
    pub nanodrop_260_280: Option<sqlx::types::BigDecimal>,
    pub nanodrop_260_230: Option<sqlx::types::BigDecimal>,
    pub contamination_status: Option<String>,
    pub adapter_contamination: Option<sqlx::types::BigDecimal>,
...
pub struct SequencingRunQc {
    ...
    pub overall_status: String,
    pub cluster_density_k_per_mm2: Option<sqlx::types::BigDecimal>,
    pub cluster_pf_percent: Option<sqlx::types::BigDecimal>,
    pub phix_aligned_percent: Option<sqlx::types::BigDecimal>,
    pub error_rate_percent: Option<sqlx::types::BigDecimal>,
    pub q30_percent: Option<sqlx::types::BigDecimal>,
    pub total_reads_pf_m: Option<sqlx::types::BigDecimal>,
    pub total_yield_gb: Option<sqlx::types::BigDecimal>,
...
pub struct QcMetricHistory {
    ...
    pub entity_type: String,
    pub entity_id: Uuid,
    pub metric_value: Option<sqlx::types::BigDecimal>,
