...
"""
    ...
    def export_configuration(self) -> dict[str, Any]:
        ...
        return {
            ...
            "required_fields": [
                field.name for cat in self.categories for field in cat.fields if field.required
            ],
        }
...
if __name__ == "__main__":
    ...
    for cat in config.categories:
        ...
        print(
            f"   {cat.priority}. {cat.name} ({len(cat.fields)} fields, {required_count} required)"
        )
    ...
    print("   Added genomics-specific fields")

    print("\n✅ Configuration system ready!")
    print("💡 You can now customize categories for your specific laboratory workflow")
