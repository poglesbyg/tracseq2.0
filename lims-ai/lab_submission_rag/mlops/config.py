...
class ConfigManager:
    ...
    def _get_default_config(self) -> dict[str, Any]:
        ...
        return {
            ...
            "development": {
                "database": {"url": "sqlite:///mlops_dev.db"},
                "monitoring": {"health_check_interval_seconds": 60},
                "security": {"api_key_required": False, "encryption_enabled": False},
            },
            "staging": {
                "database": {"url": "postgresql://user:pass@localhost:5432/mlops_staging"},
                "deployment": {"container_registry_url": "registry.staging.company.com"},
            },
            "production": {
                "database": {
                ...
                "model_registry": {"backup_enabled": True, "backup_interval_hours": 6},
                "monitoring": {"health_check_interval_seconds": 15, "alert_cooldown_minutes": 5},
                "deployment": {
                    "container_registry_url": "registry.company.com",
                    "default_replicas": 3,
                },
                "security": {"audit_logging": True, "session_timeout_minutes": 30},
            },
        }
        ...
        for env_var, config_path in env_mappings.items():
            ...
            if env_value:
                ...
                if final_key.endswith(
                    ("_seconds", "_minutes", "_hours", "_days", "connections", "size")
                ):
