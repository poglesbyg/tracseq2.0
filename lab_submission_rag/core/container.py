...
from .interfaces import (
    ...
    IHealthChecker, ICacheProvider, IConfigurationProvider
)
from .factories import (
    DocumentProcessorFactory, VectorStoreFactory, LLMInterfaceFactory,
    RetryPolicyFactory, CircuitBreakerFactory
)
...
class ServiceContainer:
    ...
    def _initialize_health_checkers(self) -> None:
        ...
        try:
            ...
            health_checkers = {
                'document_processor': DocumentProcessorHealthChecker(self.resolve('document_processor')),
