...
class SourceMaterial(BaseModel):
    ...
    chain_of_custody: Optional[List[str]] = Field(default_factory=list, description="Chain of custody information")
...
class PoolingInfo(BaseModel):
    ...
    samples_in_pool: Optional[List[str]] = Field(default_factory=list, description="Sample IDs in pool")
    pooling_ratio: Optional[Dict[str, float]] = Field(default_factory=dict, description="Pooling ratios")
    barcode_sequences: Optional[Dict[str, str]] = Field(default_factory=dict, description="Barcode sequences")
...
class SequenceGeneration(BaseModel):
    ...
    index_sequences: Optional[List[str]] = Field(default_factory=list, description="Index sequences")
    quality_metrics: Optional[Dict[str, float]] = Field(default_factory=dict, description="Quality metrics")
...
class InformaticsInfo(BaseModel):
    ...
    computational_requirements: Optional[str] = Field(None, description="Special computational requirements")
